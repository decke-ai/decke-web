...
function mapRecordToCompany(record: {
  ...
  return {
    ...
    logo: (values.logo as string) || (values.logo_url as string) || (values.company_logo as string) || (values.company_logo_url as string),
    logo_url: (values.logo_url as string) || (values.logo as string) || (values.company_logo_url as string) || (values.company_logo as string),
